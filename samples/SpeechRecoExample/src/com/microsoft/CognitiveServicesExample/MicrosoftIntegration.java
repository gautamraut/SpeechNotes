...
public class MicrosoftIntegration extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_microsoft_integration);
...
//
	...
	private void updateSuccessUI() {
		...
		Log.d("Hack", "authentication completed");
...
//						Log.d(TAG, "error response is " + error.toString() );
...
//						params.put("Authorization", authResult.getAccessToken());
//						return params;
//					}
//
//
//				};
		...
		try
		{
			...
			body.put("content", "dummydatatatatat");
